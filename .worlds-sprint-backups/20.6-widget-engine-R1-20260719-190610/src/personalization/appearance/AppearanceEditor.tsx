...
export default function AppearanceEditor({ value, onChange }: Props) {
  ...
  return <section className="appearance-editor">
    ...
    <div className="appearance-editor__body">
      ...
      {tab !== "themes" && tab !== "objects" && tab !== "companions" && tab !== "effects" ? <div className="appearance-editor__coming-soon"><span>{tab.toUpperCase()}</span><h4>Studio foundation ready</h4><p>This section is reserved for the next focused sprint.</p></div> : null}
    </div>
  </section>;
}
