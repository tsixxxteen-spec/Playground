  ...
  try {
    ...
    return {
      ...
      avatarSrc: Object.prototype.hasOwnProperty.call(parsed, "avatarSrc")
        ...
        : fallback.avatarSrc,
      avatarTransforms: parsed.avatarTransforms && typeof parsed.avatarTransforms === "object" ? parsed.avatarTransforms : fallback.avatarTransforms,
      soundtrack: normalizeSoundtrack(parsed.soundtrack ?? fallback.soundtrack),
...
export default function YourPlayground({
  ...
  const fallbackProfile = useMemo<EditableProfile>(() => ({
    ...
    soundtrack: musicTrack ? { ...EMPTY_PROFILE_SOUNDTRACK, tracks: [{ id: "default-profile-track", title: musicTrack.title, artist: musicTrack.artist ?? displayName, sourceType: "upload", source: musicTrack.audioSrc }] } : EMPTY_PROFILE_SOUNDTRACK,
