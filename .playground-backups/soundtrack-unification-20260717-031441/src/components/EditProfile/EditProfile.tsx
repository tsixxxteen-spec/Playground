...
export default function EditProfile({
  ...
  const submit = (
    ...
    /* Transfer temporary blob URL ownership to the saved profile. */
    temporaryTrackUrlsRef.current.clear();
    ...
    >
      ...
      >
        ...
        <div className="edit-profile__content">
          ...
          <section className="edit-profile__music edit-profile__music--legacy">
