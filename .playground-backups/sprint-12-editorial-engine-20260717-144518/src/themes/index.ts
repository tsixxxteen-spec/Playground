...
export const playgroundThemes: PlaygroundTheme[] = [
  ...
  {
    id: "cinema-editorial",
    name: "Cinema Editorial",
    description:
      "A cinematic magazine layout with oversized type, portrait-led storytelling, pull quotes, and film-journal pacing.",
    layout: "editorial",
    musicPlacement: "hero",
    className: "theme-cinema-editorial",
    colors: {
      background: "#f3f0e8",
      surface: "#ffffff",
      foreground: "#111111",
...

  {
    ...
    description:
      "An elegant fashion-magazine profile with refined serif typography, asymmetrical portrait layouts, generous whitespace, and campaign-style pacing.",
    layout: "editorial",
    musicPlacement: "card",
    className: "theme-fashion-editorial",
    colors: {
      background: "#f7f5f0",
      surface: "#ffffff",
      foreground: "#111111",
...

  {
    ...
    description:
      "A music magazine layout featuring a cover story, featured release, pull quotes, and an editorial portfolio.",
    layout: "editorial",
    musicPlacement: "hero",
    className: "theme-music-editorial",
    colors: {
      background: "#0d0d0d",
      surface: "#171717",
      foreground: "#f2efe7",
