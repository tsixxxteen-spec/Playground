...
export const builtinObjects: PersonalizationObjectDefinition[] = [
  ...
  { id: "personal-plant", name: "Plant", description: "A calm leafy accent for quieter corners.", category: "Nature", icon: "♧", keywords: ["green", "leaf"], lane: PLAYGROUND_LANES.MUSIC, component: ObjectGlyph, fallbackLabel: "PL", defaultAction: { type: "water-plant" }, defaultScale: .92 },
  { id: "personal-coffee", name: "Coffee", description: "A warm desk-side cup.", category: "Desk", icon: "◡", keywords: ["mug", "drink"], lane: PLAYGROUND_LANES.MUSIC, component: ObjectGlyph, fallbackLabel: "CF", defaultAction: { type: "sip-coffee" }, defaultScale: .76 },
  { id: "personal-moon-lamp", name: "Moon Lamp", description: "A lunar light with a dreamy presence.", category: "Atmosphere", icon: "◐", featured: true, keywords: ["light", "night", "space"], lane: PLAYGROUND_LANES.MUSIC, component: ObjectGlyph, fallbackLabel: "MO", defaultAction: { type: "toggle-light" }, defaultScale: .9 },
  ...
  { id: "personal-pixel-cat", name: "Pixel Cat", description: "A tiny companion for your digital room.", category: "Companions", icon: "=＾", keywords: ["pet", "8-bit"], lane: PLAYGROUND_LANES.MUSIC, component: ObjectGlyph, fallbackLabel: "CAT", defaultAction: { type: "pet-companion" }, defaultScale: .78 },
];
